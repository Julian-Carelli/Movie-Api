...
const movieReducer = (state, action) => {
    ...
    switch(type) {
        case "ADD_TO_FAVORITE":
            const favoriteIsDuplicate = state.favorites.some(favorite => favorite.id === payload.favorites.id);
        ...
        case "DELETE_TO_FAVORITE":
            const currentFavorites = state.favorites.filter(favorite => favorite.id !== payload.favorites.id);
            return {
                ...state,
